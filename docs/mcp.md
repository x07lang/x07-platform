...
- Native-aware device release and incident responses surface the shared baseline fields directly from the driver: `native_summary`, `release_readiness`, `latest_native_health_rollup`, `native_classification`, `native_context`, `native_replay_hints`, and regression status/artifact refs.
